...
class OwnAccount extends StatefulWidget {
  const OwnAccount({Key? key}) : super(key: key);

  @override
  _OwnAccountState createState() => _OwnAccountState();
}

class _OwnAccountState extends State<OwnAccount> {
...
Widget customButton(
    ...
    TextEditingController _restname,
    bool isLoading) {
  return GestureDetector(
      onTap: () {
        if (_name.text.isNotEmpty &&
            ...
            _restname.text.isNotEmpty &&
            _phone.text.isNotEmpty) {
          setState(() {
            isLoading = true;
          });

          createOwnAccount(_name.text, _email.text, _password.text, _phone.text,
                  _restname.text)
              .then((user) {
            if (user != null) {
              setState(() {
