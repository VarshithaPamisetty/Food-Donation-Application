...
class DonateSuccessful extends StatefulWidget {
  const DonateSuccessful({Key? key}) : super(key: key);

  @override
  _DonateSuccessfulState createState() => _DonateSuccessfulState();
}

class _DonateSuccessfulState extends State<DonateSuccessful> {
  @override
