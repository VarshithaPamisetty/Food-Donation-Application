...
import 'package:cibus/volunteer/order_accepted.dart';
...
class SelectedRestaurant extends StatefulWidget {
  ...
  @override
  _SelectedRestaurantState createState() => _SelectedRestaurantState();
}
      ...
      body: Center(
        child: Column(
          children: [
            ...
            Container(
              ...
              child: Padding(
                ...
                child: Text(
                  ...
                  style:
                      const TextStyle(color: Color(0xFF1A1A1A), fontSize: 20),
                ),
              ),
            )),
            SizedBox(
            ...
            customButton2(size, context, widget.restName, widget.address,
                widget.quantity, widget.userid),
          ],
        ),
      ),
    );
...
Widget customButton2(Size size, BuildContext context, String _restName,
    String _address, String _quantity, String _userid) {
  return GestureDetector(
      onTap: () {
        Navigator.push(
            context,
